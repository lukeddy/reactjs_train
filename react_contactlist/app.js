...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactsList = __webpack_require__(158);
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_ContactsList2['default'], { listContacts: this.props.contacts })
				);
			}
		}]);
	...
	_react2['default'].render(_react2['default'].createElement(App, { contacts: mycontacts }), document.getElementById('app'));
	...
	**/
	...
	var ContactsList = (function (_React$Component) {
	  ...
	  function ContactsList() {
	    ...
	    _get(Object.getPrototypeOf(ContactsList.prototype), 'constructor', this).call(this);
	    this.state = {
	      search: ''
	    };
	  }
	  ...
	  _createClass(ContactsList, [{
	    ...
	    value: function render() {
	      ...
	      var filteredContacts = this.props.listContacts.filter(function (contact) {
	        return contact.name.toLowerCase().indexOf(_this.state.search.toLowerCase()) !== -1; //如果找不到则不返回
	      });
